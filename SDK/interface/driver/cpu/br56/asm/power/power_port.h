...
//
//*****************************************************************************/
#define GET_SFC_PORT()		((JL_SFC_IOMC->IOMC0 >> 1) & 0x1)
...
//FSPG define bit
#define     FSPG_A              0   //FSPG output bit
#define     FSPG_CSA_EN         1   //FSPG CS0 connect enable bit
#define     FSPG_HD0            2   //FSPG HD0
#define     FSPG_HD1            3   //FSPG HD1
#define     FSPG_OE             4   //FSPG output enable bit
#define     FSPG_PD             5   //FSPG pull down enable bit
#define     FSPG_PD1            6   //FSPG pull down enable bit
#define     FSPG_CSB_EN         7   //FSPG CS1 connect enable bit
...
#define 	SPI0_FSPG_A		IO_PORTP_01
...
//A B C F, P USB
#define PORT_TABLE(arg)		u32 gpio_confi##arg[6] = {IO_PORT_PA_MASK, IO_PORT_PB_MASK, IO_PORT_PC_MASK, IO_PORT_PF_MASK, IO_PORT_PP_MASK, IO_PORT_USB_MASK}
