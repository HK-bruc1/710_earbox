...
#define IRQ_SPI1_IDX            10		//0
#define IRQ_IIC0_IDX            11		//0
#define IRQ_PORT_IDX            12		//0
#define IRQ_GPADC_IDX           13		//0
//#define IRQ_UART2_IDX           14		//0

#define IRQ_LRCT_IDX            15		//0
#define IRQ_GPCNT0_IDX          16
#define IRQ_QDEC0_IDX           17
#define IRQ_SD0_IDX             18
#define IRQ_USB_SOF_IDX         19
#define IRQ_USB_CTRL_IDX        20
#define IRQ_WWDG_IDX            21  	//1
#define IRQ_TIME3_IDX           22  	//1
#define IRQ_LED_IDX             23  	//1
#define IRQ_SD0_BRK_IDX         24  	//1
#define IRQ_MCPWM_TMR_IDX       25  	//1
#define IRQ_MCPWM_CHX_IDX       26
// #define IRQ_TIME4_IDX           29
// #define IRQ_TIME5_IDX           30
// #define IRQ_SPI2_IDX            31
// #define IRQ_LEDC_IDX            32

#define IRQ_PMU_SOFT0_IDX       49
#define IRQ_PMU_SOFT1_IDX       50
#define IRQ_PMU_SOFT2_IDX       51
#define IRQ_PMU_SOFT3_IDX       52

#define IRQ_P33_IDX             53
#define IRQ_PINR_IDX            54

#define IRQ_PMU_TMR0_IDX        55
#define IRQ_PMU_TMR1_IDX        56
#define IRQ_VLVD_IDX        57

// #define IRQ_PMU_TMR2_IDX        40
// #define IRQ_PMU_TMR3_IDX        41
// #define IRQ_SPDIF_M_IDX       	42
// #define IRQ_SPDIF_S_IDX       	43

#define IRQ_AES_IDX             65
#define IRQ_SRC0_IDX            66
#define IRQ_EQ_IDX              67
#define IRQ_SPI0_IDX            68

#define IRQ_SRC1_IDX            69//待删除

#define IRQ_SBC_IDX             84
#define IRQ_ALINK0_IDX          86
#define IRQ_AD2DA_IDX           87
#define IRQ_ADC_IDX             88
#define IRQ_AUDIO_IDX           89
#define IRQ_ANC_IDX             90

//#define IRQ_BT_DBG_IDX          77

#define IRQ_BT_TIMEBASE_IDX     100		//10
#define IRQ_BLE_RX_IDX          101		//2
#define IRQ_BLE_EVENT_IDX       102		//1
#define IRQ_BT_CLKN_IDX         103		//2
#define IRQ_BREDR_IDX           104		//2
#define IRQ_BT_RXMCH            105		//2
#define IRQ_SYNC_IDX            106		//1
