...
pre_build:
	$(info +PRE-BUILD)
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_MIDI_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -D__LD__ -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=0 -DEXPORT_PLATFORM_ANC_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_ICSD_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=0 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_SOMATOSENSORY_ENABLE=1 -E -P build/genFileList.c -o build/fileList.dumy
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_MIDI_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -D__LD__ -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=0 -DEXPORT_PLATFORM_ANC_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_ICSD_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=0 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_SOMATOSENSORY_ENABLE=1 -E -P build/fileList.c -o build/fileList.mk
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_MIDI_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -D__LD__ -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=0 -DEXPORT_PLATFORM_ANC_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_ICSD_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=0 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_SOMATOSENSORY_ENABLE=1 -E -P apps/earphone/sdk_used_list.c -o apps/earphone/sdk_used_list.used
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_MIDI_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -D__LD__ -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=0 -DEXPORT_PLATFORM_ANC_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_ICSD_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=0 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_SOMATOSENSORY_ENABLE=1 -E -P cpu/br56/sdk_ld.c -o cpu/br56/sdk.ld
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_MIDI_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -D__LD__ -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=0 -DEXPORT_PLATFORM_ANC_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_ICSD_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=0 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_SOMATOSENSORY_ENABLE=1 -E -P cpu/br56/tools/download.c -o $(POST_SCRIPT)
	$(QUITE) $(FIXBAT) $(POST_SCRIPT)
	$(QUITE) $(CC) $(CFLAGS) $(DEFINES) $(INCLUDES) -DEXPORT_PLATFORM_AUDIO_UART_SENDER_ENABLE=1 -DEXPORT_PLATFORM_HW_MATH_VERSION=2 -DEXPORT_PLATFORM_AUDIO_ALINK_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_MIDI_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_PDM_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_WM8978_ENABLE=0 -DEXPORT_PLATFORM_AUDIO_SPDIF_ENABLE=0 -D__LD__ -DEXPORT_PLATFORM_AUDIO_FM_ENABLE=0 -DEXPORT_PLATFORM_ANC_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SPATIAL_EFFECT_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_SMART_VOICE_ENABLE=1 -DEXPORT_PLATFORM_AUDIO_EFFECT_DEMO_ENABLE=1 -DEXPORT_PLATFORM_ICSD_ENABLE=1 -DEXPORT_LE_AUDIO_SUPPORT=0 -DEXPORT_PLATFORM_AUDIO_TDM_ENABLE=0 -DEXPORT_SOMATOSENSORY_ENABLE=1 -E -P cpu/br56/tools/isd_config_rule.c -o cpu/br56/tools/isd_config.ini
