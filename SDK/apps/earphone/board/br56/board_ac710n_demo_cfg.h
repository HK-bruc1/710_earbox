...
//                                 心率配置                                         //
//*********************************************************************************//
#define TCFG_HEART_SENSOR                1//HX3011 开启为左耳
#define TCFG_HEART_DETECTION_WEARING     0//入耳检测
#define TCFG_HEART_NUMBER                1//心率数据报数值
#define TCFG_HEART_SPO2_VOICE            1//提示音报错先包一下
