...
// u16 check_handle=0;
extern void custom_control_eq_mode_switch(void *datas);
...
void custom_sync_lyric_info(void *data)
{
    ...
    music_buf[0]=0xee;
    music_buf[1]=0xbb;
    memcpy(music_buf+offset,my_musics,8);offset+=8;
...
void phone_music_info_deal(u8 type, u32 time, u8 *info, u16 len)
{
...
extern void custom_ctrle_emitter_info(u8 *data, u16 len);
