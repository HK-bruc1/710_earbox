#ifndef _hx3011_SPO2_AGC_H_
#define _hx3011_SPO2_AGC_H_
// #include <stdint.h>
// #include <stdbool.h>
#include "hx3011.h"
...
#define SPO2_CAL_INIT_LED_GREEN 64
#define SPO2_CAL_INIT_LED_RED 64
#define SPO2_CAL_INIT_LED_IR 64
...
void hx3011_spo2_cal_init(void);
void hx3011_spo2_cal_off(void);

void read_spo2_data_packet(int32_t *buf);
void read_spo2_ir_packet(int32_t *buf);
void hx3011_spo2_read_data(int32_t *buf);

void hx3011_spo2_low_power(void);
void hx3011_spo2_normal_power(void);
...
uint8_t hx3011_spo2_read_data_packet(int32_t *s_buf);
