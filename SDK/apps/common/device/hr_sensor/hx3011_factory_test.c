...
void hx3011_factory_ft_card_test_config(void)//ª“ø®10mm∏ﬂ∂»≤‚ ‘≈‰÷√
{
...
void hx3011_factory_ft_leak_light_test_config(void)//¬©π‚≤‚ ‘≈‰÷√
{
    uint16_t sample_rate = 25;                  /*config the data rate of chip alps2_fm ,uint is Hz*/
    uint32_t prf_clk_num = 32000/sample_rate;   /*period in clk num, num = Fclk/fs */
...
void hx3011_factory_ft_int_test_config(void)//÷–∂œ≤‚ ‘≈‰÷√
{
}
